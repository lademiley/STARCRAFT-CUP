...
const transactions = [
  { id: 1, date: '2027-03-20', desc: 'Ticket sales — QF Match 1', type: 'Income', amount: 4200000, status: 'Confirmed' },
  { id: 2, date: '2027-03-18', desc: 'GTBank sponsorship installment', type: 'Income', amount: 7500000, status: 'Confirmed' },
  { id: 3, date: '2027-03-16', desc: 'Stadium hire — Ogbemudia (QF)', type: 'Expense', amount: -3500000, status: 'Paid' },
  { id: 4, date: '2027-03-15', desc: 'Merchandise sales (Week 2)', type: 'Income', amount: 2100000, status: 'Confirmed' },
  { id: 5, date: '2027-03-12', desc: 'Security staff payment', type: 'Expense', amount: -1800000, status: 'Paid' },
  { id: 6, date: '2027-03-10', desc: 'MTN Nigeria sponsorship', type: 'Income', amount: 4000000, status: 'Confirmed' },
  { id: 7, date: '2027-03-08', desc: 'Medical supplies & first aid', type: 'Expense', amount: -620000, status: 'Paid' },
]
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: '0.8rem', color: 'rgba(255,255,255,0.45)' }}>Revenue, expenses, and profit tracking</p>
        </div>
        <select value={period} onChange={e => setPeriod(e.target.value)} style={c.select}>
          <option>This Season</option><option>March 2027</option><option>February 2027</option>
        </select>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14, marginBottom: 24 }}>
        ...
        <StatCard label="Collection Rate" value="94%" icon="✅" color="#3B82F6" change="6% pending" />
      </div>
      ...
      <SectionCard title="📋 Recent Transactions" action="">
        ...
        <div style={{ marginTop: 16, padding: '14px 16px', background: 'rgba(212,175,55,0.06)', border: '1px solid rgba(212,175,55,0.15)', borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontWeight: 700, color: '#fff' }}>Season Net Position</span>
