...
export default function ChairmanLogin() {
  ...
  const handleSubmit = async e => {
    ...
    setLoading(true)
    try {
      const res = await fetch('/api/chairman/login', {
        method: 'POST',
    ...
    <div className="auth-page">
      ...
      <div className="auth-container" style={{ maxWidth: 420 }}>
        <div className="auth-card card">
          ...
          <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.5)', marginBottom: 24 }}>Sign in to manage your LGA</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="form-group">
              ...
              <input type="email" className="form-control" placeholder="chairman@email.com" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} autoComplete="email" required />
            </div>
            <div className="form-group">
